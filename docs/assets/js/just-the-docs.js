...
{"0": {
    ...
    "content": "The following applications are provided to demonstrate basic camera capabilities for 32-bit Microchip Microprocessor &amp; Microcontroller devices. | Libcamera Display | . This application capture video frames from camera module interface and display the captured frames on the display using Microchip development board. ",
    "url": "http://localhost:4000/vision/apps/readme.html",
    "relUrl": "/apps/readme.html"
  },"2": {
    "doc": "Libcamera Display",
    "title": "Camera Demo using SAM9x75-DDR3-EB board",
    "content": ". This application capture raw video frames of VGA resolution from Sony IMX219 camera module using MIPI CSI2 interface and display the captured frames on the LVDS display using SAM9x75-DDR3-EB target board. | MPLABX Configuration | Board Configuration | . | libcamera_lvds_sam9x75_eb.X | SAM9X75-DDR3-EB Early Access Evaluation Board using the MIPI CSI interface to capture video frames from the Sony IMX219 Camera Module and display it on to the AC69T88A LVDS dispaly | . | Hardware components | Images | Details | . | Development Board | | SAM9x75-DDR3-EB | . | Camera Module | | imx219 image sensor | . | Ribbon Cable | | Ribbon Cable is specifically designed for MIPI camera module with one end is 15 Pin 1.0mm Pitch interface and the other end is 22 Pin 0.5mm interface | . | AC69T88A LVDS display | | Contact Microchip sales team | . | LVDS Adapter board | | Contact Microchip sales team | . ",
    "url": "http://localhost:4000/vision/apps/libcamera_display/readme.html#camera-demo-using-sam9x75-ddr3-eb-board",
    "relUrl": "/apps/libcamera_display/readme.html#camera-demo-using-sam9x75-ddr3-eb-board"
  },"3": {
    "doc": "Libcamera Display",
